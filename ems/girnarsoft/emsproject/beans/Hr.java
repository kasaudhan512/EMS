...
public class Hr extends Employee implements IEmployee {
    
    public Hr(String firstName, String lastName, String designationOfEmployee, int pin, int employeeId) {
        super(firstName, lastName, designationOfEmployee, pin, employeeId);
        
    }
    
    public Hr(int employeeId, String firstName, String lastName, String designationOfEmployee, int mPIN) {
