...
public class Director extends Employee implements IEmployee {
    
    Scanner scanner = new Scanner(System.in);
    public Director(String firstName, String lastName, String designationOfEmployee, int pin, int employeeId) {
        super(firstName, lastName, designationOfEmployee, pin, employeeId);
    }
    public Director(int employeeId, String firstName, String lastName, String designationOfEmployee, int mPIN) {
